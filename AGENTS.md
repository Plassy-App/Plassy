...
| Topic | Rule |
| ----- | ---- |
| **Integration branch** | One long-lived branch: `main`. Preview and prod are **environments**, not branches. Legacy `preview` branches are obsolete — safe to delete once validated. |
